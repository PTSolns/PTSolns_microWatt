...
class microWatt 
{
  ...
  uint8_t begin(const int LED = LED_buildIn, const int number_of_blink = 4, int time_on_blink = 50, int time_off_blink = 50);
  void blink(const int LED = LED_buildIn, int number_of_blink = 4, int time_on_blink = 50, int time_off_blink = 50);
